...
// SelectToMap provides a mock function with given fields: ctx, req, args
func (_m *MockPSQLDriver) SelectToMap(ctx context.Context, req string, args ...interface{}) (map[string]interface{}, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, req)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	if len(ret) == 0 {
		panic("no return value specified for SelectToMap")
	}
