...
const file_proto_shortener_proto_rawDesc = "" +
	"\n" +
	"\x15proto/shortener.proto\x12\x17shortener.grpcstv.proto\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2 .shortener.grpcstv.proto.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xb0\x02\n" +
	"\x10ShortenerService\x12e\n" +
	"\n" +
	"ShortenURL\x12*.shortener.grpcstv.proto.URLShortenRequest\x1a+.shortener.grpcstv.proto.URLShortenResponse\x12b\n" +
	"\tExpandURL\x12).shortener.grpcstv.proto.URLExpandRequest\x1a*.shortener.grpcstv.proto.URLExpandResponse\x12Q\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a).shortener.grpcstv.proto.UserURLsResponseBBZ@github.com/nk87rus/go-musthave-shortener/internal/router/grpcsrvb\beditionsp\xe8\a"

var file_proto_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: shortener.grpcstv.proto.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: shortener.grpcstv.proto.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: shortener.grpcstv.proto.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: shortener.grpcstv.proto.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: shortener.grpcstv.proto.UserURLsResponse
	(*URLData)(nil),            // 5: shortener.grpcstv.proto.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_proto_shortener_proto_depIdxs = []int32{
	5, // 0: shortener.grpcstv.proto.UserURLsResponse.url:type_name -> shortener.grpcstv.proto.URLData
	0, // 1: shortener.grpcstv.proto.ShortenerService.ShortenURL:input_type -> shortener.grpcstv.proto.URLShortenRequest
	2, // 2: shortener.grpcstv.proto.ShortenerService.ExpandURL:input_type -> shortener.grpcstv.proto.URLExpandRequest
	6, // 3: shortener.grpcstv.proto.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: shortener.grpcstv.proto.ShortenerService.ShortenURL:output_type -> shortener.grpcstv.proto.URLShortenResponse
	3, // 5: shortener.grpcstv.proto.ShortenerService.ExpandURL:output_type -> shortener.grpcstv.proto.URLExpandResponse
	4, // 6: shortener.grpcstv.proto.ShortenerService.ListUserURLs:output_type -> shortener.grpcstv.proto.UserURLsResponse
