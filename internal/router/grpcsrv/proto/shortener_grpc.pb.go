...
const (
	ShortenerService_ShortenURL_FullMethodName   = "/shortener.grpcstv.proto.ShortenerService/ShortenURL"
	ShortenerService_ExpandURL_FullMethodName    = "/shortener.grpcstv.proto.ShortenerService/ExpandURL"
	ShortenerService_ListUserURLs_FullMethodName = "/shortener.grpcstv.proto.ShortenerService/ListUserURLs"
)
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shortener.grpcstv.proto.ShortenerService",
